  ...
  return (
    <div>
      <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:24}}>
        <h2 style={{margin:0}}>Crear nuevo pedido de cliente</h2>
        <button onClick={()=>setMostrarHistorial(m=>!m)} style={{padding:'8px 16px',background:'#1976d2',color:'#fff',border:'none',borderRadius:6,fontWeight:600}}>
      ...
      {mostrarHistorial && (
        <HistorialPedidosClientes clienteId={clienteSeleccionado?.id || clienteSeleccionado?._id || clienteSeleccionado?.codigo} />
      )}
    </div>
  );
}
