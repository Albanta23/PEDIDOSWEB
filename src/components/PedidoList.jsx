...
export default function PedidoList({ pedidos, onModificar, onBorrar, onEditar, modo, tiendaActual, onRefrescarPedidos }) {
  ...
  const REFERENCIAS_CERDO = ["lomo", "panceta", "solomillos", "costilla", "chuletero", "carrilleras", "pies", "manteca", "secreto", "papada", "jamon", "paleta", "paleta tipo york", "maza de jamon"];
